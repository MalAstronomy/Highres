...
### PT profile
    ...
    fig_pt = PT_plot(fig, ax, theta_filterLD[:2**8], invert = True) #, self.theta_star)
...
####################################################################################################
    ...
    x_filterLD_512 = np.stack([simulator(t) for t in tqdm(theta_filterLD_512)]) #**9
    ...
    x_filterLD_512 = noisy(x_filterLD_512.cuda())
